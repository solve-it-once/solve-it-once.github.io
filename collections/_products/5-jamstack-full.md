...
<div class="layout--row display--flex flex-direction--row-reverse">
  ...
  <aside class="layout--column flex--3 padding-horizontal--4 padding-horizontal--collapse">
    ...
    <p>I'm gonna level with you: this is a very niche product, and might not be what you're looking for. Sites made
      with <a href="https://github.com/lowerbarriers/finished-starter">finished-starter</a> (such as this one you're on
      right now) require someone with a working knowledge of at least markdown, and ideally a decent amount of HTML, to
      do any significant work.
    </p>

    <p>If you're comfortable with that, and acknowledge that Brad can only get so much done in 9 hours of development, you
      could very well love the low lifetime cost of hosting and maintaining a site like this.
    </p>
...
things will happen fast:
  ...
  5. Brad will develop the site, based on your form responses and provided files
  6. Approximately 3 business days (assuming Brad's availability) after purchase, the agreed-to development and content items
   will be completed and ready for launch. Depending on if your needs are more involved than nine hours' worth, you may
...
The 9-hour engagement can be used for development, planning, architecture, meetings, design, copywriting, testing, and other
vital work toward a launch-able site. Approximately 1 of the hours will inevitably go toward setting up the codebase and
other administrative items, so around 8 hours is reasonable to plan for some suggested items:
...
Mix and match items from above, or request specifically what you want us to focus on, for up to 9 hours of customization
...
Also the following:
  ...
  * VS Code, [.editorconfig](https://github.com/lowerbarriers/finished-starter/blob/gh-pages/.editorconfig) and GitHub Codespaces settings for quick dev setup anywhere
